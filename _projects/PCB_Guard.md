...
<img src="{{ site.baseurl }}/assets/images/projects/PCB_Guard/0.png" alt="Soccerbot Action" class="rounded-md object-cover shadow-lg border border-gray-800 hover:border-recOrange transition-colors">
